...
#SBATCH --output=/groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/scripts/logs/log2_regenie_GSA_PLINK.out
#SBATCH --error=/groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/scripts/logs/log2_regenie_GSA_PLINK.err
...
gzip dataG_GSA_v1.b*
mv dataG_GSA_* /groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/output/GSA-PLINK/
